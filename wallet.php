        ...
        <div class="row">
            <div class="content">
                ...
                $coins=$_SESSION['all["coins"]']; 
                    echo '<h1>Your wallet<br/><i class="material-icons" style="font-size:50px;color:#ff3333">account_balance_wallet</i></h1>';
                    echo '<div class="card">';                   
                    echo 'You have <strong>Rs. '.$coins.'</strong> in your wallet';
                    echo '<br/><br/><small>*You can only use wallet coins for orders more than Rs. 99<small>';
                    echo '</div>';
                    ?>
