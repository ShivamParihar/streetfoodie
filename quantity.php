    ...
    <body>
        ...
        <div class="row">
            <div class="content">
                ...
                $price = $_SESSION['all["price"]'];
                ?>
                <div class="flex-container">
                    <?php
                    echo '<div style="width:90%;">';
                    echo '<div class="icon_image" style="background-image: url(\'images/final.jpg\');"></div>';
                    echo '<div class="body_image">' . $res_name . '<br/>' . $dish_name . '<br/>Rs.' . $price . '<br/></div>';
                    echo '</div>';
                    ?>
                    <form action="set_order.php" method="post">
                        <h4>Quantity</h4>      
                        <input style="border:1px solid black;width:auto;" type="text" name="quantity" required>
