...
<html lang=en>
    <head>
        ...
        <title>Order one step away</title>
        <style>
    ...
    <body>       
        ...
        <div class="row">
            <div class="content">
                ...
                echo '<h2>This order will be delivered to '.$address.'</h2>';                
                ?>
                <div class="flex-container" style="display:block;">
                
                <h4>To change address click on below button</h4>
                 <p class='add_button'><a href='change_address.php'>Change</a></p><br/><br/>
                
                <h4>To order on this address click below</h4>
                <p class='add_button'><a href='final_order.php'>Order</a>
                </div>
            </div>
        </div>
