        ...
        <div class="row">
            <div class="content">
                ...
                <h1>Terms and condition</h1>
                    ...
                    <p>
                    T & C for flat 50% cashback offer<br/><br/>
                    * 50% cashback is only valid for first order and will be credited in your streetfoodie wallet.<br/>
                    *Prior customer who are already registered with us can also avail this offer.<br/>
                    *The cashback in your wallet is applicable to all your further orders.<br/>
                    * You can only use Rs.20 from cashback on a minimum order of Rs.100 one at a time.<br/>
                    * Offer is valid till 20 October 2018.
                    </p>             
                    </div>                
